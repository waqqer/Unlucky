        ...
        <>
            <div className={styles.content}>
                ...
                <div className={styles.controlls}>
                    <Button className={styles.profile_btn} id="badges" onClick={badges.open} isDisabled={account === null}>
                    ...
                    <Button className={styles.profile_btn} id="promocode" onClick={promo.open} isDisabled={account === null}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                    ...
                    <Button className={styles.profile_btn} id="referal" onClick={referral.open} isDisabled={account === null}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
